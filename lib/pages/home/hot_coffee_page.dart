...
class _HotCoffeePageState extends State<HotCoffeePage>
  ...
  final List<ProductModel> hotCoffeeProducts = [
    ProductModel(
    ...
    ProductModel(
      name: "Flat White",
      price: 27.00,
      image: "assets/images/products/flat_white.png",
    ),
    ProductModel(
                        ...
                        child: AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            return PageView.builder(
                              itemCount: hotCoffeeProducts.length,
                      ...
                      Positioned(
                        ...
                        child: Column(
                          children: [
                                ...
                                itemBuilder: (context, index) {
                                  return Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "\$${hotCoffeeProducts[index % hotCoffeeProducts.length].price.toStringAsFixed(2)}",
                                        textAlign: TextAlign.center,
                                        style: const TextStyle(
                                          fontSize: 16,
                                          color: Colors.white,
                            ...
                            SmoothPageIndicator(
                              controller: _imageSlideController,
                              count: hotCoffeeProducts.length,
